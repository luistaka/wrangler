...
public class DateAndTimeTest {
  ...
  public void testDateFromDaysSince() throws Exception {
    ...
    rows = TestingRig.execute(directives, rows);
    Assert.assertTrue(rows.size() == 1);
    Assert.assertEquals(DateAndTime.getDate("2008-08-05"), rows.get(0).getValue("DateFromDaysSince1"));
    Assert.assertEquals(DateAndTime.getDate("1958-08-17"), rows.get(0).getValue("DateFromDaysSince2"));
  }
  ...
  public void testDateFromComponents() throws Exception {
    ...
    rows = TestingRig.execute(directives, rows);
    Assert.assertTrue(rows.size() == 1);
    Assert.assertEquals(DateAndTime.getDate("2010-12-02"), rows.get(0).getValue("DateFromComponents1"));
    Assert.assertEquals(DateAndTime.getDate("1958-08-18"), rows.get(0).getValue("DateFromComponents2"));
    Assert.assertEquals(DateAndTime.getDate("2020-03-07"), rows.get(0).getValue("DateFromComponents3"));
  }
  ...
  public void testDateOffsetByComponents() throws Exception {
    ...
    rows = TestingRig.execute(directives, rows);
    Assert.assertTrue(rows.size() == 1);
    Assert.assertEquals(DateAndTime.getDate("2013-08-18"), rows.get(0).getValue("DateOffsetByComponents1"));
    Assert.assertEquals(DateAndTime.getDate("2013-09-17"), rows.get(0).getValue("DateOffsetByComponents2"));
    Assert.assertEquals(DateAndTime.getDate("2014-01-17"), rows.get(0).getValue("DateOffsetByComponents3"));
  }
  ...
  public void testDaysSinceFromDate() throws Exception {
    ...
    List<Row> rows = Arrays.asList(new Row(
      "a", DateAndTime.getDate("2008-08-18")).add(
      "b", DateAndTime.getDate("1958-08-18"))
    );
  ...
  public void testDaysInMonth() throws Exception {
    ...
    List<Row> rows = Arrays.asList(new Row(
      "a", DateAndTime.getDate("1958-08-18"))
    );
  ...
  public void testDaysInYear() throws Exception {
    ...
    List<Row> rows = Arrays.asList(new Row(
      "a", DateAndTime.getDate("2012-08-18"))
                                     .add("b", DateAndTime.getDate("2011-08-18"))
    );
  ...
  public void testDateOffsetByDays() throws Exception {
    ...
    rows = TestingRig.execute(directives, rows);
    Assert.assertTrue(rows.size() == 1);
    Assert.assertEquals(DateAndTime.getDate("2011-08-20"), rows.get(0).getValue("DateOffsetByDays1"));
    Assert.assertEquals(DateAndTime.getDate("2011-07-18"), rows.get(0).getValue("DateOffsetByDays2"));
  }
  ...
  public void testNextWeekdayFromDate() throws Exception {
    ...
    rows = TestingRig.execute(directives, rows);
    Assert.assertTrue(rows.size() == 1);
    Assert.assertEquals(DateAndTime.getDate("2008-08-21"), rows.get(0).getValue("NextWeekdayFromDate1"));
    Assert.assertEquals(DateAndTime.getDate("2008-08-21"), rows.get(0).getValue("NextWeekdayFromDate2"));
  }
  ...
  public void testNthWeekdayFromDate() throws Exception {
    ...
    rows = TestingRig.execute(directives, rows);
    Assert.assertTrue(rows.size() == 1);
    Assert.assertEquals(DateAndTime.getDate("2009-08-20"), rows.get(0).getValue("NthWeekdayFromDate1"));
    Assert.assertEquals(DateAndTime.getDate("2009-08-20"), rows.get(0).getValue("NthWeekdayFromDate2"));
    Assert.assertEquals(DateAndTime.getDate("2009-08-06"), rows.get(0).getValue("NthWeekdayFromDate3"));
    Assert.assertEquals(DateAndTime.getDate("2009-08-06"), rows.get(0).getValue("NthWeekdayFromDate4"));
  }
  ...
  public void testPreviousWeekdayFromDate() throws Exception {
    ...
    rows = TestingRig.execute(directives, rows);
    Assert.assertTrue(rows.size() == 1);
    Assert.assertEquals(DateAndTime.getDate("2008-08-14"), rows.get(0).getValue("PreviousWeekdayFromDate1"));
    Assert.assertEquals(DateAndTime.getDate("2008-08-14"), rows.get(0).getValue("PreviousWeekdayFromDate2"));
  }
  ...
  public void testTimeFromComponents() throws Exception {
    ...
    rows = TestingRig.execute(directives, rows);
    Assert.assertTrue(rows.size() == 1);
    Assert.assertEquals(DateAndTime.getTime("10:12:02.0"), rows.get(0).getValue("TimeFromComponents"));
  }
  ...
  public void testTimeFromMidnightSeconds() throws Exception {
    ...
    rows = TestingRig.execute(directives, rows);
    Assert.assertTrue(rows.size() == 1);
    Assert.assertEquals(DateAndTime.getTime("00:04:00"), rows.get(0).getValue("TimeFromMidnightSeconds1"));
    Assert.assertEquals(DateAndTime.getTime("00:04:00"), rows.get(0).getValue("TimeFromMidnightSeconds2"));
  }
  ...
  public void testTimestampFromDateTime() throws Exception {
    ...
    rows = TestingRig.execute(directives, rows);
    Assert.assertTrue(rows.size() == 1);
    Assert.assertEquals(DateAndTime.getTimestamp("2008-08-18 22:30:52"), rows.get(0).getValue("TimestampFromDateTime"));
  }
  ...
  public void testTimestampFromSecondSince() throws Exception {
    ...
    rows = TestingRig.execute(directives, rows);
    Assert.assertTrue(rows.size() == 1);
    Assert.assertEquals(DateAndTime.getTimestamp("2008-08-18 23:13:35"), rows.get(0).getValue("TimestampFromSecondSince"));
  }
  ...
  public void testTimestampFromTimet() throws Exception {
    ...
    rows = TestingRig.execute(directives, rows);
    Assert.assertTrue(rows.size() == 1);
    Assert.assertEquals(DateAndTime.getTimestamp("2009-02-13 23:31:30"), rows.get(0).getValue("TimestampFromEpoch1"));
    Assert.assertEquals(DateAndTime.getTimestamp("2009-02-13 23:31:30"), rows.get(0).getValue("TimestampFromEpoch2"));
  }
  ...
  public void testTimestampFromTime2() throws Exception {
    ...
    rows = TestingRig.execute(directives, rows);
    Assert.assertTrue(rows.size() == 1);
    Assert.assertEquals(DateAndTime.getTimestamp("2008-08-18 12:03:22"), rows.get(0).getValue("TimestampFromTime"));
  }
  ...
  public void testTimestampOffsetByComponents() throws Exception {
    ...
    rows = TestingRig.execute(directives, rows);
    Assert.assertTrue(rows.size() == 1);
    Assert.assertEquals(DateAndTime.getTimestamp("2009-10-14 16:05:49"), rows.get(0).getValue("a"));
  }
  ...
  public void testTimestampOffsetBySeconds() throws Exception {
    ...
    rows = TestingRig.execute(directives, rows);
    Assert.assertTrue(rows.size() == 1);
    Assert.assertEquals(DateAndTime.getTimestamp("2009-08-18 23:11:29"), rows.get(0).getValue("a"));
  }

...
public final class DateAndTime {
  ...
  @VisibleForTesting
  static LocalDateTime getTimestamp(String date) {
  ...
  /**
   * Returns a timestamp from the given epoch time specified in seconds.
   *
  ...
  /**
   * Returns a timestamp from the given time and timestamp objects.
   * The value in the time object overwrites the time value in the timestamp object
   * so that only the date part is used from the timestamp.
   *
  ...
  /**
   * @return Returns the timestamp, with offsets applied from the base timestamp.
   */
  ...
  /**
   * @return Returns the timestamp, with offsets applied from the base timestamp with seconds offset.
   */
  ...
  /**
   * @return Returns a UNIX epoch time from the given timestamp.
   */
